// LOAD_IsOpen_RacingOrBattle @ 0x800348e8  (vs SCUS_944.26.exe)  SCORE 0 — exact match.
// Predicate: gGT->overlayIndex_Threads (@0x2541) == 1 (racing/battle overlay loaded).
...
{
    return D_8008D2AC->overlayIndex_Threads == 1;
}
